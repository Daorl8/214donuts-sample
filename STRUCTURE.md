...
## ⚠️ 교체 대상 / 확인 필요 (납품 전)
- **주소**: ✅새 주소 **춘천로 387**로 교체 완료(본문 Visit·JSON-LD·푸터). 옛 서부대성로 196 폐기. ⚠️네이버 place 링크(1908467449)는 그대로 — 이전 반영 시 place ID 바뀔 수 있어 확인 필요. **⚠️영업시간/상단 티커가 아직 "reopening mid-September"라 새 주소와 불일치** → 실제 오픈일·영업시간 확정 시 티커·Hours행 갱신 필요(사장님 컨펌).
